 ...
 */
final class Version20250108202253 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE local_events ADD user_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_54F575CFA76ED395 ON local_events');
        $this->addSql('ALTER TABLE local_events DROP COLUMN user_id');
    }
}
